...
class Service(object):
    ...
    """
    def __init__(self, id=None, accessaccount_id=None, name=None, pending_cancel=None, credit_cost=None, total_recipients=None, send_at=None, created_at=None, updated_at=None):
        """
    ...
    def accessaccount_id(self):
        """
        Gets the accessaccount_id of this Service.
        Unique identifier for the access account which initiated this if available.

        :return: The accessaccount_id of this Service.
        :rtype: str
        """
    ...
    def accessaccount_id(self, accessaccount_id):
        """
        Sets the accessaccount_id of this Service.
        Unique identifier for the access account which initiated this if available.

        :param accessaccount_id: The accessaccount_id of this Service.
        :type: str
        """
    ...
    def pending_cancel(self):
        """
        Gets the pending_cancel of this Service.
        Whether the service has been flagged to be cancelled.

        :return: The pending_cancel of this Service.
        :rtype: bool
        """
    ...
    def pending_cancel(self, pending_cancel):
        """
        Sets the pending_cancel of this Service.
        Whether the service has been flagged to be cancelled.

        :param pending_cancel: The pending_cancel of this Service.
        :type: bool
        """
    ...
    def credit_cost(self):
        """
        Gets the credit_cost of this Service.
        The amount of credits required to schedule this service.

        :return: The credit_cost of this Service.
        :rtype: float
        """
    ...
    def credit_cost(self, credit_cost):
        """
        Sets the credit_cost of this Service.
        The amount of credits required to schedule this service.

        :param credit_cost: The credit_cost of this Service.
        :type: float
        """
    ...
    def total_recipients(self):
        """
        Gets the total_recipients of this Service.
        The amount of recipients for this service.

        :return: The total_recipients of this Service.
        :rtype: float
        """
    ...
    def total_recipients(self, total_recipients):
        """
        Sets the total_recipients of this Service.
        The amount of recipients for this service.

        :param total_recipients: The total_recipients of this Service.
        :type: float
        """
    ...
    def send_at(self):
        """
        Gets the send_at of this Service.
        When the service will be sent.

        :return: The send_at of this Service.
        :rtype: str
        """
    ...
    def send_at(self, send_at):
        """
        Sets the send_at of this Service.
        When the service will be sent.

        :param send_at: The send_at of this Service.
        :type: str
        """
